		...
		<h1>Door</h1>
			<div class="content">
				...
				<div class="content">
					...
					<?php global $arr; if($arr[38] == 1){echo '<div class="alert red">PIN entered incorrectly X time(s) (!)'; echo '<input type="submit" name = "alert9" class="alertButton" value="Clear"> </div>';} ?>
					...
					<?php global $arr; if($arr[36] == 1){echo '<div class="alert orange" >Resident has not take his medicine yet (!)'; echo '<input type="submit" name = "alert7" class="alertButton" value="Clear"> </div>';} ?>
