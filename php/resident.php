...
<h1>Dashboard</h1>
 ...
 <div class="container-80"> <!-- Container van 80% breedte, bevadt de meeste knoppen -->
		...
		<h1>Bed</h1>
			<div class="content">
				<input type="submit" name = "button1" class="button" value=" Toggle Nightlight <?php //global $arr; echo $arr[1]; //toont de huidige waarde van de corresponderende ID.?>"> <!--Led, Bed-->
					<?php
				...
				<div class="led-group">
					<div class="led <?php global $arr; if($arr[3] >= 0){echo "green";}else{echo "grey";}?>" value="Pressuresensor (Bed)"><p><?php global $arr; echo $arr[3];?></p></div> <!-- Pressure Sensor, Bed-->
		...
		<h1>Chair</h1>
			...
			<!--<input type="submit" name = "button5" class="button" value="Led (Chair) <?php global $arr; echo $arr[5]; ?>"> <!-- Led, Chair -->
					...
					?>
				<div class="led-group">
					<div class="led <?php global $arr; if($arr[6] >= 0){echo "green";}else{echo "grey";}?>" value="Pressuresensor (Chair)"><p><?php global $arr; echo $arr[6];?></p></div> <!-- Led, Lamp -->
					<div class="Led-desc"> Pressuresensor </div>
				</div>
				<div class="led-group">
		...
		<!--<div class="led-group">
					<div class="led <?php global $arr; if($arr[13] == 1){echo "green";}else{echo "grey";}?>" value="Smoke"><p><?php global $arr; if($arr[13] == 1){echo "ON";}else{echo "OFF";}?></p></div><!-- Smoke, Column -->
		...
		<div class="device">
			...
			<!--<input type="submit" name = "button18" class="button" value="Cooler + Fan <?php global $arr; echo $arr[18]; ?>"> <!-- Cooler + Fan, Fridge -->
					...
					?>
			<!--<div class="led-group">
					<div class="led <?php global $arr; if($arr[19] == 1){echo "green";}else{echo "grey";}?>" value="Inner Temp"><p><?php global $arr; if($arr[19] == 1){echo "ON";}else{echo "OFF";}?></p></div> <!-- Temp binnen, Fridge -->
				<!--<div class="Led-desc">Inner Temp.</div>
					</div>
				<div class="led-group">			
					<div class="led <?php global $arr; if($arr[20] == 1){echo "green";}else{echo "grey";}?>" value="Outer Temp"><p><?php global $arr; if($arr[20] == 1){echo "ON";}else{echo "OFF";}?></p></div> <!-- Temp buiten, Fridge -->
		...
		<h1>Lamp</h1>
			...
			<input type="submit" name = "button8" class="button" value="Toggle <?php //global $arr; echo $arr[8]; ?>"> <!-- Led, Lamp-->
					<?php
	...
	<div class="container-20">
		<div class="device" id="door">
			...
			<div class="content">
				...
				<h1>Notifications</h1> <!-- alerts van de verschillende devices.-->
				<div class="content">
					...
					<?php global $arr; if($arr[35] == 1){echo '<div class="alert orange">Timothy, please take your medicine.'; echo '<input type="submit" name = "alert6" class="alertButton" value="Clear"> </div>';} ?>
					...
					<?php global $arr; if($arr[34] == 1){echo '<div class="alert orange">Timothy, please close the fridge door.'; echo '<input type="submit" name = "alert5" class="alertButton" value="Clear"> </div>';} ?>
